...
public class ShimmerFrameLayout extends FrameLayout {
  ...
  public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        if (a.hasValue(R.styleable.ShimmerFrameLayout_shapes)) {
          int shape = a.getInt(R.styleable.ShimmerFrameLayout_shapes, 0);
          switch (shape) {
            default:
            case 0:
   ...
   */
  @SuppressLint("NewApi") public void startShimmerAnimation() {
  ...
  @SuppressLint("NewApi") private Animator getShimmerAnimation() {
    if (mAnimator != null) {
      return mAnimator;
    }
    int width = getWidth();
