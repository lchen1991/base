...
import com.base.app.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.base.app.widget.pulltorefresh.internal.LoadingLayout;
import com.base.app.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.base.app.widget.pulltorefresh.internal.Utils;
import com.base.app.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public final void smoothScrollTo(int newScrollValue, long duration,
		...
		LogUtil.e("info", "oldScrollValue:" + oldScrollValue + ";"
	 ...
	 * // 自动下拉刷新
	 */
	public void getAutoOnRefresh(OnSmoothScrollFinishedListener finishedListener) {
		this.setState(State.REFRESHING, false);
		Log.e("info", "++++++++++++===="+mHeaderLayout.getHeight()+"------------------"+getHeaderSize());
		this.smoothScrollTo(-80,200, 0,finishedListener);
		//demo();
//		smoothScrollToAndBack(-getHeaderSize() * 2);
//		 new OnSmoothScrollFinishedListener() {
//				@Override
//				public void onSmoothScrollFinished() {
//					smoothScrollTo(0, 200, 0, null);
//				}
//			}
	}
