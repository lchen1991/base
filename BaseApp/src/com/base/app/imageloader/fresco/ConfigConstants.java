...
package com.base.app.imageloader.fresco;
...
//				  .setLowResImageRequest(ImageRequest.fromUri(lowResUri))//先下载显示低分辨率的图
	  ...
	  public static Drawable sProcessDrawable;
	  
	  @SuppressWarnings("deprecation")
	 public static void init(final Resources resources) {
		    if (sPlaceholderDrawable == null) {
		      sPlaceholderDrawable = resources.getDrawable(R.drawable.placeholder_drawle);
		    }
		    if (sErrorDrawable == null) {
		      sErrorDrawable = resources.getDrawable(R.drawable.failure_drawle);
		    }
		    if(sProcessDrawable !=null)
		    {
		    	sProcessDrawable = resources.getDrawable(R.drawable.process_drawle);
		    }
		  }
